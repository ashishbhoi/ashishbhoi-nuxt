    ...
    <nav class="bg-gray-800 px-2 sm:px-4 py-2.5 fixed w-full">
        <div class="container flex flex-wrap items-center justify-between mx-auto">
            ...
            <div id="navbar-default" class="hidden w-full md:block md:w-auto">
                <ul
                        class="flex flex-col mt-4 rounded-lg bg-gray-800 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0">
                    <li>
                        <NuxtLink :class="{ 'nav-menu-active': homeMenu, 'nav-menu': !homeMenu }" aria-current="page"
                                  to="/">Home
                        </NuxtLink>
                    </li>
                    <li>
                        <NuxtLink :class="{ 'nav-menu-active': projectsMenu, 'nav-menu': !projectsMenu }"
                                  to="/projects">
                            Projects
                        </NuxtLink>
                    </li>
                    <li>
                        <NuxtLink :class="{ 'nav-menu-active': aboutMenu, 'nav-menu': !aboutMenu }" to="/about">About
                        </NuxtLink>
                    </li>
                    <li>
                        <NuxtLink :class="{ 'nav-menu-active': contactMenu, 'nav-menu': !contactMenu }" to="/contact">
                            Contact
                        </NuxtLink>
                    </li>
                    <li>
...
let homeMenu = true
let projectsMenu = false
let aboutMenu = false
let contactMenu = false
let check = true;
...
if (props.activeMenu === "projects") {
    defaultMenu()
    projectsMenu = true
}
if (props.activeMenu === "about") {
    defaultMenu()
    aboutMenu = true
}
if (props.activeMenu === "contact") {
    defaultMenu()
    contactMenu = true
}
